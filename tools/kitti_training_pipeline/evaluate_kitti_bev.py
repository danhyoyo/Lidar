...
from prepare_kitti import (invert_rigid_transform, normalize_yaw,
                           parse_calibration, transform_vector)
...
def load_ground_truth(frame_id: str, root: Path,
    ...
    rect_to_velo = invert_rigid_transform(parse_calibration(calib_path))
    ...
    for line_number, line in enumerate(
        ...
        center = transform_vector(rect_to_velo, np.array([cx, cy, cz, 1.0]))
        heading = transform_vector(rotation, np.array(
