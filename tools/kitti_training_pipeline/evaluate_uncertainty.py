...
def main(argv=None):
    ...
    result = {"raw": evaluate_arrays(errors, log_vars, log_var_min, log_var_max), "matched_samples": int(len(errors)),
              ...
              "provenance": {
                  ...
                  "test_split_sha256": sha256(args.split),
                  "test_predictions_sha256": sha256(args.predictions),
              }}
    ...
    if args.calibration_predictions:
        ...
        result["provenance"].update(
            calibration_split_sha256=sha256(args.calibration_split),
            calibration_predictions_sha256=sha256(args.calibration_predictions),
        )
